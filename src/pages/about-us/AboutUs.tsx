            ...
            <section className='d-flex flex-column p-5' id='about-us-b'>
                ...
                <div className='h-100 w-100 row row-cols-1 row-cols-lg-2'>
                    ...
                    <div className='col d-flex align-items-center justify-content-center'>
                        <h1 className='w-100 h-75 border d-flex align-items-center justify-content-center about-us-image-round'>Insert image here</h1>
                    </div>
                </div>

                <div className='d-flex justify-content-end w-75'>
                    <div className='d-flex justify-content-center align-items-center my-2 float-right' id='about-us-vision-tag'>
                        <p className='text-center about-us-vision w-100 h-100 m-0 mt-2'>Vision of the founder</p>
                    </div>
                </div>
                <div className='h-100 w-100 row row-cols-1 row-cols-lg-2'>
                ...
                <div className='d-flex justify-content-center align-items-center mb-2' id='about-us-vision-tag'>
                    <p className='text-center about-us-vision w-100 h-100 m-0'>Vision of the founder</p>
                </div>
                <div className='h-100 w-100 row row-cols-1 row-cols-lg-2'>
                    <div className='col d-flex flex-column align-items-start justify-content-start'>
                        <h2 className='fw-bolder w-75 mb-4'>
