...
export const terms: TermsAndConditionItem[] = [
    {title: '1. Agreement Overview', description: ['These Terms and Conditions ("Agreement") constitute a legally binding agreement between JOB4ME and the individual or entity “Customer” availing the CV writing services provided by the Company. By using the Company\'s services, the Customer agrees to abide by these terms.']},
    ...
    {title: '10. Modifications to Terms', description: ['10.1 The Company reserves the right to modify these terms at its discretion. By using the JOB4ME services, the Customer acknowledges and agrees to the terms outlined in this Agreement.']}
]